...
const restartBtn = document.getElementById("buttonStart");
...
function resetGame() {
    clearInterval(gameInterval); // 停止前一場遊戲
    ...
    // 重置蘋果
    apple.x = Math.floor(Math.random() * MAP_SIZE);
    apple.y = Math.floor(Math.random() * MAP_SIZE);
